...
function CreateNavLink(page: IPageProps, i: number): ReactElement {
  ...
  return (
    <li key={i} className="relative group">
      ...
      {/* Dropdown menu */}
      <ul className="absolute z-10 left-0 mt-2 bg-white rounded-md shadow-lg py-1 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
